  ...
  return (
    <>
      ...
      <input
        type="color"
        ref={inputRef}
        class="p-1 h-10 w-1/2 block mx-auto bg-white border border-gray-400 cursor-pointer rounded-lg disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700"
        id="hs-color-input"
        value={selectedColor}
